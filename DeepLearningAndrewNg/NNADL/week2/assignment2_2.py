...
if __name__ == '__main__':
    ...
    print("y = " + str(train_set_y[:, index]) + ", it's a '" + classes[np.squeeze(train_set_y[:, index])].decode(
        "utf-8") + "' picture.")
    # Find the value
    # To keep the matrix/vector dimensions straight
    ...
    # the pixel value is actually a vector of three numbers ranging from 0 to 255
    ...
    # Merge all the thing into a model
    ...
    my_image = trans.resize(image, (num_px, num_px)).reshape((1, num_px * num_px * 3)).T
